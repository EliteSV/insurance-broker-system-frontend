    ...
    return (
        <>
            ...
            <Form.Item
                ...
                rules={[{ required: true, message: 'Por favor, ingrese el año de fabricación!' }]}
            >
            ...
            <Form.Item
                label="Color"
                name={["detalles", "color"]}
                rules={[{ required: true, message: 'Por favor, seleccione el color del vehículo!' }]}
            >
                <Input />
            </Form.Item>
