...
import { useLazyGetCSRFCookieQuery, useForgotPasswordMutation } from "../api/api";
...
const ForgotPassword = () => {
    ...
    const onFinish = async (values: any) => {
        try {
            ...
            message.success("Correo de restablecimiento de contraseña enviado, revisa tu correo");
            navigate("/login");
        } catch (error) {
